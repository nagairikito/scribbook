...
// dd($result['resources'][0]);
                        if($oldPublicId) {
                            ...
                            $uploadApi->rename($oldPublicId, 'blog_contents_images/' . $imageNames[$index], [
                                'overwrite' => false
                            ]);
                        }
                    } else {
